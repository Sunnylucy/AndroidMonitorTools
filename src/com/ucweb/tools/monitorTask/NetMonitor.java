...
public class NetMonitor extends AbstractMonitor{
	...
	public void startMonitor() {
		...
		final String fileName = createFileName("NetInfo", mMonitorPkgName);
	...
	private long[] getTrafficChangeBytes(int uid){
		...
		try {
			TimeUnit.SECONDS.sleep(Integer.parseInt(MonitorType.COLLECT_FREQUENCY_NET));
		} catch (Exception e) {
